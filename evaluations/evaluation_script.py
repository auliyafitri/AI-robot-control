...
def create_range(x):
    # create list with correct episodes for the average values to plot. Starting at Episode 100 as the first one
    episode_range = []
    for i in range(x + 1):
        if i >= 100:
...
if __name__ == '__main__':
    ...
    # Define Name of the CSV File with Trainingsresults in the evaluations Folder
    ...
    reshape_lists(steps)
    # Creates a list which defines if an episode reached its goal
    reached_goal()
